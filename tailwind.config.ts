    ...
    extend: {
      ...
      keyframes: {
        ...
        "butterfly-fly": {
          ...
          "25%": { 
            transform: "translate(60vw, 60vh) rotate(-15deg) scale(1.1)",
            opacity: "1"
          },
          "50%": { 
            transform: "translate(30vw, 30vh) rotate(10deg) scale(0.9)",
            opacity: "1"
          },
          "75%": { 
            transform: "translate(10vw, 10vh) rotate(-5deg) scale(1)",
            opacity: "0.8"
          },
          "100%": { 
        ...
        "hotspot-pulse": {
          "0%, 40%, 60%, 100%": { 
            boxShadow: "0 0 0 0 rgba(200, 16, 46, 0.15)",
            transform: "scale(1)"
          },
          "48%, 52%": { 
      ...
      animation: {
        ...
        "hotspot-pulse": "hotspot-pulse 25s linear infinite",
